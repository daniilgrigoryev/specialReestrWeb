<template>
  <Layout v-if="cardAccounting" class="height100-header flex-parent flex-parent--column bg-gray">
    <table-poptip v-if="showExpire" :expDate="expDate"
                  @createExpireReestr="createExpireCard"></table-poptip>
                ...
                <Col :xs="{span: 24}" :md="{span: 24}" :lg="{span: 12}">
                  <Card :padding="5" dis-hover bordered class="hmin300">
                    ...
                    <table class='table border--0'>
                      ...
                      <tr>
                        <td>Срок действия</td>
                        <td class="txt-bold">{{cardAccounting.item.permitStartDate + ' - ' +
                          cardAccounting.item.permitEndDate}}
                        </td>
                      </tr>
                      <tr>
                        <td>Дата создания</td>
                        <td class="txt-bold">{{cardAccounting.item.createdTime | formatDateTime('DD.MM.YYYY HH:mm')}}
                        </td>
                      </tr>
                      </tbody>
                    </table>
              ...
              <Card :padding="5" dis-hover bordered>
                ...
                <table v-if="cardAccounting.fisItem" class="table border--0">
                  ...
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Фамилия(организация)</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.avFirst !== cardAccounting.fisItem.avFirst ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.avFirst}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.avFirst !== cardAccounting.fisItem.avFirst ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.avFirst}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">ГРЗ</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.regno !== cardAccounting.fisItem.regno ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.regno}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.regno !== cardAccounting.fisItem.regno ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.regno}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Марка ТС</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.marka !== cardAccounting.fisItem.marka ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.marka}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.marka !== cardAccounting.fisItem.marka ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.marka}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Модель</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.model !== cardAccounting.fisItem.model ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.model}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.model !== cardAccounting.fisItem.model ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.model}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Тип ТС</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.typeTcName !== cardAccounting.fisItem.typeTcName ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.typeTcName}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.typeTcName !== cardAccounting.fisItem.typeTcName ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.typeTcName}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Год выпуска ТС</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.yearAvto !== cardAccounting.fisItem.yearAvto ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.yearAvto}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.yearAvto !== cardAccounting.fisItem.yearAvto ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.yearAvto}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Цвет</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.color !== cardAccounting.fisItem.color ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.color}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.color !== cardAccounting.fisItem.color ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.color}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    ...
                    <td
                      ...
                      class="border--0 px0 py0">{{cardAccounting.fisItem.vin}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.vin !== cardAccounting.fisItem.vin ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.vin}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Номер кузова</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.nkuzov !== cardAccounting.fisItem.nkuzov ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.nkuzov}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.nkuzov !== cardAccounting.fisItem.nkuzov ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.nkuzov}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Номер шасси</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.nshasi !== cardAccounting.fisItem.nshasi ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.nshasi}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.nshasi !== cardAccounting.fisItem.nshasi ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.nshasi}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Тип кузова</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.typeKuzovName !== cardAccounting.fisItem.typeKuzovName ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.typeKuzovName}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.typeKuzovName !== cardAccounting.fisItem.typeKuzovName ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.typeKuzovName}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Мощность л/c</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.powerLs !== cardAccounting.fisItem.powerLs ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.powerLs}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.powerLs !== cardAccounting.fisItem.powerLs ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.powerLs}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Мощность кВт</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.powerKwt !== cardAccounting.fisItem.powerKwt ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.powerKwt}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.powerKwt !== cardAccounting.fisItem.powerKwt ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.powerKwt}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Максимальная масса</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.massaDop !== cardAccounting.fisItem.massaDop ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.massaDop}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.massaDop !== cardAccounting.fisItem.massaDop ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.massaDop}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Масса полная</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.massaTotal !== cardAccounting.fisItem.massaTotal ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.massaTotal}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.massaTotal !== cardAccounting.fisItem.massaTotal ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.massaTotal}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Объем двигателя</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.vmotorCm3 !== cardAccounting.fisItem.vmotorCm3 ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.vmotorCm3 + ' см'}}<sup>3</sup></td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.vmotorCm3 !== cardAccounting.fisItem.vmotorCm3 ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.vmotorCm3 + ' см'}}<sup>3</sup></td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Тип двигателя</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.typeMotor !== cardAccounting.fisItem.typeMotor ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.typeMotor}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.typeMotor !== cardAccounting.fisItem.typeMotor ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.typeMotor}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Номер двигателя</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.nmotor !== cardAccounting.fisItem.nmotor ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.nmotor}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.nmotor !== cardAccounting.fisItem.nmotor ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.nmotor}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Количество мест</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.posadMest !== cardAccounting.fisItem.posadMest ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.posadMest}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.posadMest !== cardAccounting.fisItem.posadMest ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.posadMest}}
                    </td>
                  </tr>
                  <tr class="txt-bold">
                    <td class="border--0 px0 py0 color-gray">Экологический класс</td>
                    <td
                      :style="{color: null !== fisLoadData && fisLoadData.ecologClass !== cardAccounting.fisItem.ecologClass ? 'red' : '#3f3f3f'}"
                      class="border--0 px0 py0">{{cardAccounting.fisItem.ecologClass}}
                    </td>
                    <td v-if="fisLoadData"
                        :style="{color: fisLoadData.ecologClass !== cardAccounting.fisItem.ecologClass ? 'red' : '#3f3f3f'}"
                        class="border--0 px0 py0">{{fisLoadData.ecologClass}}
                    </td>
                  </tr>
                  </tbody>
                </table>
        ...
        <div style="height: 100%; overflow: auto">
          ...
          <Row v-if="cardAccounting.loadItems">
            <Col :sm="{span: 12}" :md="{span: 12}" :xl="{span: 18}">
              <Table ref="selection" :columns="columnsOption" :data="cardAccounting.loadItems" size="small"
                     :show-header="false" @on-row-click="selectPackage" :height="tableHeight">
              </Table>
            </Col>
            <Col v-if="package" :sm="{span: 12}" :md="{span: 12}" :xl="{span: 6}" style="overflow: auto;"
              ...
              <Card dis-hover style="height: 100%;">
                <Row>
                  ...
                  <Col :xs="{span: 12}" :md="{span: 12}">
                    <button type="button" @click="getPackageCard"
                            class="flex-parent flex-parent--row flex-parent--center-cross">
            ...
            <Col v-else :sm="{span: 12}" :md="{span: 12}" :xl="{span: 6}" style="overflow: auto;"
                 :style="{height: tableHeight + 'px'}">
              <div class="prose--dark bg-gray" style="display: table; width: 100%; height: 100%;">
                <div style="display: table-cell;text-align: center; vertical-align: middle;" class="txt-h3">Актуальное
                  состояние карточки
                </div>
              </div>
            </Col>
  ...
  export default {
    ...
    computed: {
      cardAccounting() {
        ...
        if (data) {
          this.showExpire = data.item.tcId !== null && data.item.flgActive !== 'F';
