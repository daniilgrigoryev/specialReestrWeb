<template>
  ...
  <div class="wrapper mx-auto">
    <Row type="flex" align="middle" class="py36">
      <Col :xs="{span: 24}" :md="{span: 4}">
        <h2 class="txt-h2 my12">Список записей</h2>
      </Col>
      <Col :xs="{span: 24}" :md="{span: 4}">
        <Button type="primary" @click="addRow">+</Button>
      </Col>
      <Col :xs="{span: 24,  offset: 1}" :md="{span: 18}">
        <Card>
          <Steps :current="page">
    ...
    <Card class="py0">
      ...
      <Row v-if="page === 0" class="my24" :gutter="36">
